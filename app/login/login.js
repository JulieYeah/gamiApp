...
angular.module('login', ['ngRoute'])
  ...
  $http({
    ...
    function welcomeText() {
      ...
      MESSAGES.push({
        delay: 1200,
        text: $scope.credentials.username+", finally you are here. Welcome."
      });
      
      MESSAGES.push({
        delay: 2200,
        text: "I need you to focus on your missions."
      });
      
      MESSAGES.push({
        delay: 3600,
        text: "Okay? Promise me..."
      });
      ...
      scramble = function(element, text, options) {
        ...
        $filter('orderBy')(order,null,true,shuffle());
